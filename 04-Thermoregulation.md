...
Body temperature on the skin’s surface is much lower than the temperature of tissues deep inside the body - the so-called "core temperature."  For humans, the core temperature is normally between 98$^{\circ}$F and 98.6$^{\circ}$F (measured orally).  Even when exposed for several hours to ambient temperatures between 60$^{\circ}$F and 130$^{\circ}$F, our core temperature varies little - from 97$^{\circ}$F to 100$^{\circ}$F.  [](#Fig4-1) illustrates this stability of the core temperature.
```{figure} ./images/Topic4/Fig4-1.jpg
:width: 100%
:align: center
:alt: Effect of ambient temperature on internal body temperature.  Note the stability of the core temperature despite wide variations in atmospheric temperature.
:label: Fig4-1
Effect of ambient temperature on internal body temperature.  Note the stability of the core temperature despite wide variations in atmospheric temperature.
```  
...
Radiation accounts for about 60\% of the body’s total heat loss.  All bodies emit energy in the form of electromagnetic radiation.  People and objects give off waves with different wavelengths and intensities, depending on their temperature.  Humans emit waves in the infrared part of the electromagnetic spectrum. See [](#hand_ir) 
```{figure} ./images/Topic4/hand.jpg
:width: 70%
:align: center
:alt: Image of a hand taken with a Seek Thermal Nano 200 cell phone camera.
:label: hand_ir
Image of a hand taken with a Seek Thermal Nano 200 cell phone camera.
```  
Infrared goggles or cameras allow users to see the "glow" emitted by living creatures by detecting these waves and converting them to visible ones.  
...
To vaporize 1 g of water at room temperature (25$^{\circ}$C), 0.58 kcal heat must be transferred to the water. The energy to evaporate water is the latent heat of vaporization. As shown in [](#Fig4-2), at the surface temperature of the body ($T$ = 306 K) the heat of vaporization is $L \approx 2400$ kJ/kg.
```{figure} ./images/Topic4/Fig4-2.png
:width: 80%
:align: center
:alt: The heat required to evaporate water at temperatures ranging from freezing to the critical point above which only the gaseous phase of water exists.
:label: Fig4-2
The heat required to evaporate water at temperatures ranging from freezing to the critical point above which only the gaseous phase of water exists.
```
...
### Vasodilation
Along with nutrients, blood carries heat.  Blood circulating deep within the body picks up heat, which can be subsequently carried by the circulation to the skin.  There the heat is dissipated into the environment and the cooled blood re-enters the body ready to transfer more heat.  Our bodies possess a heat sensing mechanism that regulates blood flow to the skin in relation to the need for heat dissipation. The blood flow is regulated by a network of blood vessels underneath the skin that contract or dilate as needed. For instance, these blood vessels dilate as the body’s temperature rises above the optimal range to divert greater blood flow to the skin. As much as one-third of the cardiac output can be rerouted so that heat can be removed from the body.  The effectiveness of this mechanism is demonstrated in [](#Fig4-3), which shows how much heat conduction from the core to the skin takes place as the ambient temperature rises.  
```{figure} ./images/Topic4/Fig4-3.jpg
:width: 100%
:align: center
:alt: Effect of ambient temperature changes on heat conductance from the body core to the skin surface.  At $110^{\circ}$F, the skin loses seven times as much heat through the skin because of vasodilation.
:label: Fig4-3
Effect of ambient temperature changes on heat conductance from the body core to the skin surface.  At $110^{\circ}$F, the skin loses seven times as much heat through the skin because of vasodilation.
```
  
### Sweating and Behavioral Cooling
...
Recall from Eqn. {eq}`eqn4-2` the inverse relation between $d$, the thickness of air insulating the body, and the power dissipated by the body.  Many animals can trap more insulating air around the skin by fluffing up fur or feathers.  This method of decreasing heat loss is called piloerection.  Goose bumps are an evolutionary throwback to a time when our more hairy ancestors made use of this ability.
...
# Problems
1. Heat is lost from the surface of the body through multiple process.
	* a. Estimate the rate at which heat is lost through the entire surface area of the body due to radiation when the skin is a 90$^{\circ}$F and the surrounding environment is at 60$^{\circ}$F. Express the answer in Watts.
	* b. Estimate the corresponding rate due to heat conduction assuming that the body is surrounded by a layer of air 1 cm deep. The heat conductivity of air is $6\times 10^{-5}$ cal/(sec.cm.K). Express the answer in Watts.

2. A typical human loses 0.6 liters of water every day due to evaporation. Estimate the heat dissipation rate (in Watts) due to evaporation. Show every step of your estimate.

3. A 70 kg person walks up from the first floor to the fifth floor of the Science Building, approximately a 20 m climb.
	* a. What is the change in gravitational potential energy in joules?
	* b. Assuming that the body is only 20% efficient in producing mechanical energy how many joules did it actually expend to make the climb? What is this energy in kilocalories (C)?
	* c. If the remaining 80% of the energy was converted into internal energy, and assuming that the specific heat of the body is 1 cal/(g.$^{\circ}$C), what is the resulting body temperature increase resulting from the climb?

4. Consider a person who metabolizes 2500 Calories per day.  Assuming that all of those Calories are transformed into heat, how many joules were produced in one day?  What is the average power produced in Watts?

5. Suppose a 70 Kg person is running a fever of 40$^{\circ}$C.  Your idea for bringing the temperature down to normal (37$^{\circ}$C) is to have the person drink ice water (0$^{\circ}$C). How much water would the person have to drink?

6. A 70 kg person locks himself out of the house with no clothes (don’t ask why). 
	* a. Estimate the rate at which heat is lost through the entire surface area of the body due to radiation when the skin is a 90$^{\circ}$F and the surrounding environment is at 32$^{\circ}$F. Express the answer in Watts.
	* b. Estimate the corresponding rate due to heat conduction assuming that the body is surrounded by a layer of air 3 mm deep. Express the answer in watts.
	* c. Suppose the person weights 70Kg and is metabolizing at a rate similar to the in Problem 4. Assuming that the core temperature started out at 98.6$^{\circ}$F, how long will it take for this person to reach hypothermia?  Neglect evaporative cooling.
